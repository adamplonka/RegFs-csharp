...
# RegFS-csharp
[RegFS](https://github.com/Microsoft/Windows-classic-samples/tree/main/Samples/ProjectedFileSystem), a sample project for the [Windows Projected File System (ProjFS)](https://docs.microsoft.com/en-us/windows/desktop/projfs/projected-file-system) ported to the C# language and using .NET 6.0.

Below is the readme for original implementation.
